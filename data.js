...
const SHOPPING = {
  week1: {
    'Fresh Produce': [
      { amount: '3 bell peppers', item: 'Bell peppers', purpose: 'Stir-fry, Curry, Sauteed Veggies' },
      { amount: '1 bag (5 oz)', item: 'Arugula', purpose: 'Chickpea Quinoa Salad' },
      { amount: '1 bunch or bag', item: 'Fresh basil or spinach', purpose: 'Sauteed Veggies, Pasta' },
      { amount: '1.5 crowns', item: 'Broccoli', purpose: 'Various recipes, snacks' },
      { amount: '1 bag (1 lb)', item: 'Baby carrots', purpose: 'Snacks with hummus' },
      { amount: '1 bag (1 lb)', item: 'Regular carrots', purpose: 'Curry, Stir-fry, Sauteed Veggies' },
      { amount: '1 bag (15 oz)', item: 'Escarole or greens', purpose: 'Busy Day Soup' },
      { amount: '0.5 lb', item: 'Green beans', purpose: 'Curry, Stir-fry' },
      { amount: '1 bag (16 oz)', item: 'Kale', purpose: 'Kale Chips, Pasta Fagioli' },
      { amount: '1 carton (10 oz)', item: 'Crimini mushrooms', purpose: 'Mushrooms & Lentils' },
      { amount: '1 bunch', item: 'Flat-leaf Italian parsley', purpose: 'Garnish' },
      { amount: '0.5 head', item: 'Red cabbage', purpose: '4 Bean Salad' },
      { amount: '1 bunch', item: 'Scallions/green onion', purpose: 'Stir-fry, garnish' },
      { amount: '1', item: 'Tomato', purpose: 'Salads' },
      { amount: '1', item: 'Zucchini', purpose: 'Curry, Stir-fry, Sauteed Veggies' },
      { amount: '1 large tub (16 oz)', item: 'Spring mix', purpose: 'Green salads' },
      { amount: '1 bag', item: 'Romaine hearts', purpose: 'Green salads' },
      { amount: '2-3 lb', item: 'Potatoes', purpose: 'Snacks, Curry' },
      { amount: '1.5 lb', item: 'Sweet potatoes', purpose: 'Snack, Chili Quinoa' },
      { amount: '1 lb', item: 'Yellow or sweet onions', purpose: 'Various recipes' },
      { amount: '1 small', item: 'Red onion', purpose: 'Colorful Rice & Lentils' },
      { amount: '1 head', item: 'Garlic', purpose: 'Various recipes' },
      { amount: '1 small piece', item: 'Fresh ginger', purpose: 'Curry, Stir-fry' },
      { amount: '1 container', item: 'Strawberries or blueberries', purpose: 'Snacks and desserts' },
      { amount: '5', item: 'Bananas', purpose: 'Breakfast, snacks' },
      { amount: '4-5', item: 'Apples', purpose: 'Snacks' },
      { amount: '3-4', item: 'Oranges or clementines', purpose: 'Snacks' },
      { amount: '1-2', item: 'Lemons', purpose: 'Various recipes' }
    ],
    'Refrigerator & Freezer': [
      { amount: '1 loaf', item: 'Ezekiel 4:9 Bread', purpose: 'Breakfast, snacks, lunches' },
      { amount: '1 bag (16 oz)', item: 'Frozen broccoli', purpose: 'Pasta Fagioli, White Bean Sauce' },
      { amount: '1 bag (10 oz)', item: 'Frozen broccoli/cauliflower mix', purpose: 'Busy Day Soup' },
      { amount: '1 bag (16 oz)', item: 'Frozen corn', purpose: 'Bowls, Chili Quinoa' },
      { amount: '1 bag (12 oz)', item: 'Frozen kale', purpose: 'Pasta Fagioli' },
      { amount: '1 bag (12 oz)', item: 'Frozen mirepoix mix', purpose: 'Busy Day Soup' },
      { amount: '1 bag (16 oz)', item: 'Frozen mixed vegetables', purpose: 'Curry, Colorful Rice' },
      { amount: '1 bag (1 lb)', item: 'Frozen peas', purpose: 'White Bean Sauce, snacks' },
      { amount: '1 bag (1 lb)', item: 'Frozen spinach', purpose: 'Various recipes' },
      { amount: '1.5 lb', item: 'Frozen blueberries', purpose: 'Breakfast and snacks' },
      { amount: '1.5 lb', item: 'Frozen strawberries', purpose: 'Breakfast and snacks' }
    ],
    'Cans, Jars & Shelf Stable': [
      { amount: '2 cans', item: 'Black beans', purpose: '4 Bean Salad, Chili Quinoa' },
      { amount: '2 cans', item: 'Cannellini (white kidney) beans', purpose: 'Pasta Fagioli, White Bean Sauce' },
      { amount: '3 cans', item: 'Chickpeas (garbanzo)', purpose: 'Hummus, Salad, Curry' },
      { amount: '2 cans', item: 'Kidney beans', purpose: '4 Bean Salad, Bowls' },
      { amount: '1 can', item: 'Pinto beans', purpose: 'Pasta Fagioli' },
      { amount: '1 can', item: 'Green beans (no salt)', purpose: '4 Bean Salad' },
      { amount: '2 cans (14.5 oz)', item: 'Diced tomatoes', purpose: 'Curry, Chili Quinoa, Red Beans' },
      { amount: '1 can (14.5 or 28 oz)', item: 'Crushed tomatoes', purpose: 'Beans and Greens' },
      { amount: '1 jar', item: 'Roasted red pepper', purpose: 'Hummus' },
      { amount: '1 jar', item: 'Salsa', purpose: 'Bowls, Chili Quinoa' },
      { amount: '1 bag (1 lb)', item: 'Lentils (dry)', purpose: 'Mushrooms & Lentils, Colorful Rice' },
      { amount: '0.5 lb', item: 'Quinoa', purpose: 'Various recipes' },
      { amount: '1 lb', item: 'Brown rice', purpose: 'Various recipes' },
      { amount: '1.5 lb', item: 'Whole wheat pasta', purpose: 'Pasta Fagioli, Sauteed Veggies' },
      { amount: '1 qt', item: 'Vegetable broth (low sodium)', purpose: 'Busy Day Soup' },
      { amount: '1 carton (42 oz)', item: 'Old-fashioned oatmeal', purpose: 'Breakfast, snacks' },
      { amount: '1 box', item: 'Shredded wheat cereal', purpose: 'Breakfast' }
    ],
    'Natural Food Section': [
      { amount: '1 carton', item: 'Plant milk (unsweetened)', purpose: 'Breakfast, recipes' },
      { amount: '1 box', item: 'Whole wheat crackers', purpose: 'Snacks' }
    ]
  },
  week2: {
    'Fresh Produce - Replenish': [
      { amount: '3', item: 'Bell peppers', purpose: 'Stir-fry, Sauteed Veggies' },
      { amount: '1 crown', item: 'Broccoli', purpose: "Dr. Veggie's Favorite, snacks" },
      { amount: '1 bag', item: 'Baby carrots', purpose: 'Snacks' },
      { amount: '1 large tub', item: 'Spring mix or greens', purpose: 'Salads' },
      { amount: '2-3', item: 'Sweet potatoes', purpose: "Dr. Veggie's Favorite, Chili Quinoa" },
      { amount: '1 lb', item: 'Onions', purpose: 'Various recipes' },
      { amount: '1 head', item: 'Garlic', purpose: 'Various recipes' },
      { amount: '5', item: 'Bananas', purpose: 'Breakfast, snacks' },
      { amount: '4-5', item: 'Apples', purpose: 'Snacks' },
      { amount: '3-4', item: 'Oranges', purpose: 'Snacks' },
      { amount: '1 container', item: 'Strawberries', purpose: 'Snacks' },
      { amount: '1 bunch', item: 'Grapes', purpose: 'Snacks' },
      { amount: '1', item: 'Zucchini', purpose: 'Stir-fry' },
      { amount: '1 carton', item: 'Mushrooms', purpose: 'Stir-fry' },
      { amount: '1', item: 'Red onion', purpose: 'Bean salad, Colorful Rice' },
      { amount: '1-2', item: 'Lemons', purpose: 'Various recipes' }
    ],
    'Cans & Shelf Stable - Replenish': [
      { amount: '2 cans', item: 'Chickpeas', purpose: 'Hummus, Baked Chickpeas' },
      { amount: '1 can', item: 'Black beans', purpose: 'Chili Quinoa, Bean Salad' },
      { amount: '2 cans', item: 'Kidney beans', purpose: 'Red Beans & Rice, Bean Salad' },
      { amount: '1 can', item: 'Cannellini beans', purpose: 'Pasta Fagioli, White Bean Sauce' },
      { amount: '2 cans', item: 'Diced tomatoes', purpose: 'Red Beans, Pasta Fagioli' },
      { amount: '1 can', item: 'Crushed tomatoes', purpose: 'Beans and Greens' },
      { amount: '1 can', item: 'Green beans (no salt)', purpose: 'Bean Salad' }
    ]
  },
  infrastructure: {
    'Condiments & Staples': [
